...
void main() {
  group('NewsRemoteDataSource', () {
      ...
      test('should fetch news list from API and map to models', () async {
        ...
        result.fold(
          ...
          (response) {
            ...
            AppLogger.d('Fetched news: ${response.items.length} items, total: ${response.total}');
          },
        );
      });
    });
    ...
    group('getNewsDetail', () {
      test('should fetch news detail by id from API and map to model', () async {
      ...
      test('should fetch news stats by id from API and map to model', () async {
        ...
        result.fold(
          ...
          (stats) {
            ...
            AppLogger.d('Fetched news stats: likes=${stats.likeCount}, comments=${stats.commentCount}');
          },
        );
      });
    });
    ...
    group('getNewsGallery', () {
      test('should fetch news gallery by galleryId from API and map to models', () async {
        ...
        result.fold(
          ...
          (gallery) {
            ...
            AppLogger.d('Fetched gallery: ${gallery.items.map((i) => i.id.toString()).join('\n')}');
          },
        );
      });
    });
