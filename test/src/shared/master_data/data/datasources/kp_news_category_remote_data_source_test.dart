...
void main() {
  group('KpNewsCategoryRemoteDataSource', () {
    late KpNewsCategoryRemoteDataSource dataSource;
    ...
    setUp(() {
      ...
      dataSource = KpNewsCategoryRemoteDataSourceImpl(apiClient);
    });

    group('getKpNewsCategories', () {
      test('should fetch news categories from API and map to models', () async {
        // Act
        final result = await dataSource.getKpNewsCategories();
