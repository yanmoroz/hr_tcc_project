...
void main() {
  group('DiscountCategoryRemoteDataSource', () {
    late DiscountCategoryRemoteDataSource dataSource;
    ...
    setUp(() {
      ...
      dataSource = DiscountCategoryRemoteDataSourceImpl(apiClient);
    });

    group('getDiscountCategories', () {
      test('should fetch discount categories from API and map to models', () async {
        // Act
        final result = await dataSource.getDiscountCategories();
        ...
        result.fold(
          ...
          (models) {
            ...
            expect(models, isA<List<DiscountCategoryModel>>());
