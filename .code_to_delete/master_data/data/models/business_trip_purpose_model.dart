...
abstract class BusinessTripPurposeModel with _$BusinessTripPurposeModel {
  const factory BusinessTripPurposeModel({required String id, required String name, required bool obligation}) =
      _BusinessTripPurposeModel;

  factory BusinessTripPurposeModel.fromJson(Map<String, dynamic> json) => _$BusinessTripPurposeModelFromJson(json);
}
