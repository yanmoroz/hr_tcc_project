          ...
          body: state.when(
            ...
            loaded: (discount, likeCount, liked, commentCount, coverImage) {
              return RefreshIndicator(
                onRefresh: () async {
                  context.read<DiscountDetailBloc>().add(const DiscountDetailEvent.refresh());
                },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (discount.category != null)
                        Chip(label: Text(discount.category!.title), avatar: const Icon(Icons.category, size: 16)),
                      ...
                      if (discount.contact != null ||
                        ...
                        const SizedBox(height: 8),
                        if (discount.contact != null) _buildInfoRow(context, Icons.person, discount.contact!),
                        if (discount.phone != null) _buildInfoRow(context, Icons.phone, discount.phone!),
                        if (discount.email != null) _buildInfoRow(context, Icons.email, discount.email!),
                        if (discount.site != null) _buildInfoRow(context, Icons.language, discount.site!),
                        const SizedBox(height: 16),
                      ],
                      ...
                      Card(
                        child: ListTile(
                          ...
                          subtitle: discount.author.position != null ? Text(discount.author.position!) : null,
                        ),
                      ),
                      const SizedBox(height: 16),
                      ...
                      Row(
                        children: [
                          ElevatedButton.icon(
                            onPressed: () {
                              context.read<DiscountDetailBloc>().add(const DiscountDetailEvent.toggleLike());
                            },
                          ...
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.pushNamed(
                                context,
                                '/comments',
                                arguments: {'entityId': discountId, 'feature': 'discount'},
                              );
                            },
            ...
            error: (message) => Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      context.read<DiscountDetailBloc>().add(const DiscountDetailEvent.loadDetail());
                    },
