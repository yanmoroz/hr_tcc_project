...
abstract class DepartmentModel with _$DepartmentModel {
  const factory DepartmentModel({required int id, required String title, required bool isArchive}) = _DepartmentModel;
...
extension DepartmentModelX on DepartmentModel {
  Department toDomain() => Department(id: id, title: title, isArchive: isArchive);
}
