...
abstract class ResellListResponseModel with _$ResellListResponseModel {
  ...
  const factory ResellListResponseModel({required List<ResellItemModel> items, required int total}) =
      _ResellListResponseModel;

  factory ResellListResponseModel.fromJson(Map<String, dynamic> json) => _$ResellListResponseModelFromJson(json);
}
