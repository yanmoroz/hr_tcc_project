...
abstract class TrainingTypeModel with _$TrainingTypeModel {
  const factory TrainingTypeModel({required String id, required String code, required String name}) =
      _TrainingTypeModel;

  factory TrainingTypeModel.fromJson(Map<String, dynamic> json) => _$TrainingTypeModelFromJson(json);
}
