...
abstract class ApplicationFormGroupModel with _$ApplicationFormGroupModel {
  const factory ApplicationFormGroupModel({required String id, required int code, required String name}) =
      _ApplicationFormGroupModel;

  factory ApplicationFormGroupModel.fromJson(Map<String, dynamic> json) => _$ApplicationFormGroupModelFromJson(json);
}
