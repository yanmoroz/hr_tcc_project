...
abstract class KpDiscountSourceModel with _$KpDiscountSourceModel {
  const factory KpDiscountSourceModel({required int code, required String name}) = _KpDiscountSourceModel;

  factory KpDiscountSourceModel.fromJson(Map<String, dynamic> json) => _$KpDiscountSourceModelFromJson(json);
}
